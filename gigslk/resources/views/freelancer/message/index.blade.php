...
<div class="chat">
  ...
  <!-- Chat -->
  <div class="messages">
    @include('freelancer.message.broadcast', ['message' => "Hey! What's up!  👋"])
    @include('freelancer.message.broadcast', ['message' => "Ask a friend to open this link and you can chat with them!"])
  </div>
  <!-- End Chat -->
