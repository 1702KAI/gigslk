    ...
    <div class="max-w-2xl mx-auto">
        <form action="{{ route('freelancer.job.index') }}" method="get">
            ...
            <div class="relative">
                ...
                <input type="search" name="q" id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Web, Design" required>
